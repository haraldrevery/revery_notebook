...
- The CSS is from an old website (that uses Tailwind), I liked the aesthetics but contains a lot of dead code and is messy,
...
- Right now, emojis were used for icons in the UI. It was supposed to use the emojis from the harald revery font, but this doesn't always work and sometimes renders the emojis using the system font emojis. No idea how to reliably render icons out reliably. 
